    ...
    <div class="width-hero flex flex-col">
      <div>
        <div class="hero-margin ml-40">
          <h1 class="text-5xl pt-28 text-left">
            A clean and nice web design as <br />
            well as a logo for an old school gym.
          </h1>
          <div class="program-used flex flex-row space-x-4 pt-3">
            <p class="p-border">Adobe XD</p>
            <p class="p-border">Adobe Illustrator</p>
          </div>
        </div>
      </div>
      ...
      <div class="flex flex-col justify-center items-center">
        <img
          ...
          :src="require('@/assets/shape-hero-one.gif')"
        />
      </div>
    </div>
  </div>
